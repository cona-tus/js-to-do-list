...
Taskist는 투두리스트 웹 애플리케이션으로, 사용자가 할일을 3단계(시작전, 진행중, 완료)로 구분하여 관리할 수 있도록 제작하였습니다. 사용자의 편의에 따라 할일 목록을 정렬할 수 있으며, 그래프가 제공되어 진행 상황과 달성률을 확인할 수 있습니다. 또한 음성인식 기능으로 더욱 편리하게 이용 가능합니다.
